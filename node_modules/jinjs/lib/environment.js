(function(){
  ...
  BasicFileEnvironment = (function(_super){
     ...
     */
    prototype.getTemplate = function(path, root){
      var result;
      ...
      result = this.getTemplateFromString(result, {
        filename: path,
        root: root // <- Here I changed the relative root with static views root
      });
    ...
    prototype.getTemplateFromString = function(str, opts){
      ...
      __dirname = opts.root;  // <- It's here the root views
      ...
      __load_template = function(path){
        ...
        try {
            ...
            return _this.getTemplate(path, opts.root);
        } catch (err){
            return _this.getTemplate(path, opts.root);
        }
