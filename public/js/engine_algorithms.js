(function() {
  ...
  algorithmsTime = function(id) {
    ...
    if (value === 'Play') {
      ...
      return engine.timePause = setTimeout('engineTime()', 2000);
    }
  };
  ...
  clone = function(_ArryToClone) {
    var _Clone, _IdClone, _i, _len;
    _Clone = [];
    for (_i = 0, _len = _ArryToClone.length; _i < _len; _i++) {
      _IdClone = _ArryToClone[_i];
